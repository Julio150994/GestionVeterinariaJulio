...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2021 a las 18:05:21
...
(20, '2021-05-24', 'Informe 5', 'Cita 5', b'1', 5, 8),
(21, '2021-05-25', 'Informe 6', 'Cita 6', b'1', 4, 8),
(22, '2021-06-06', 'Informe dedicado a Blas', 'Motivo informal', b'1', 2, 12);
...
INSERT INTO `usuarios` (`id`, `activado`, `apellidos`, `nombre`, `password`, `rol`, `telefono`, `username`, `token`) VALUES
(1, b'1', 'admin', 'Admin', '$2a$10$umT0Fw0gg4NyoDs3HtXyn.MGLcRym0TQ5fP54G.Y3oIUL4/tOsY5.', 'ROLE_ADMIN', '123456789', 'admin', NULL),
(2, b'0', 'Sánchez Chozas', 'Nuria', '$2a$10$ZX2U1dzKY3ZBdlAGgWP6n.VUS.mglZP2qM6QFhhcujHYNgQjmIw/u', 'ROLE_CLIENTE', '675397345', 'nuria56', NULL),
(3, b'0', 'López Pérez', 'Juan', '$2a$10$R56EIeB3GAC2F.OdJMxANOOLzemr8QWx50VSqbfK.N840FEER0clS', 'ROLE_CLIENTE', '678487512', 'juanlope95', NULL),
(4, b'0', 'Gómez González', 'Ana Belén', '$2a$10$xOmtVe2Qi.CnXaUdyQ7tR.qycR8o0WGKojq0BZmi.Pa0D3aY1trki', 'ROLE_CLIENTE', '678568545', 'anabelen54', NULL),
(5, b'1', 'Traverso Carrero', 'Fabio', '$2a$10$mMWE8Hmun2PXR202/UPaTu.6A2/jsOTTVpyN2pINlpJTfxkgma0K2', 'ROLE_VETERINARIO', '672113415', 'fabitraver89', NULL),
(6, b'1', 'López Chozas', 'Julián', '$2a$10$Jl3IZFNcLMJJ2vet4lFA/ubSvRRxy1S/GioGHvp/lBirJAtsyIVDK', 'ROLE_VETERINARIO', '678224590', 'julianlope', NULL),
(7, b'0', 'Gomero López', 'Francisco', '$2a$10$lx4xOIKqcLWEj90PwSoK/.HL1tHKkhBM53Qk3iJACxJlc2jrDha/O', 'ROLE_CLIENTE', '672781134', 'frango1992', NULL),
(8, b'1', 'Gómez Gardón', 'Laura', '$2a$10$6CicC3jZspwXY2B6Gd2yVukghcv3.ii4Ir9HCTpBFhc7E.luz9BCa', 'ROLE_VETERINARIO', '678983216', 'lau90', NULL),
(9, b'0', 'Pérez Gardón', 'Julia', '$2a$10$mhEmAQQ5zRHzhr1TR8mHyOtqIf03GppmFs6.BRMgjXX/J2Wem16DG', 'ROLE_CLIENTE', '956892190', 'julialv1995', NULL),
(10, b'0', 'Reyes Gil', 'Álvaro', '$2a$10$/chZmZkvLyfAoIurmnCqe.f6GrMrIFnEq0SGj1vR0Se.aCPAn9Inu', 'ROLE_CLIENTE', '678443391', 'alvaroreyes54', NULL),
(11, b'1', 'Castañeda López', 'Alfredo', '$2a$10$i4F/tgCRbRhd71Knvh4Ha.dLBnq7JtAMGOdTlhSGVLDFtdydb4MSW', 'ROLE_VETERINARIO', '678998813', 'alfredocalo13', NULL),
(12, b'1', 'López Reyes', 'Ignacio', '$2a$10$erWE6SIA/t3z87imE97DqO7otqhi9X2dAIEIzBl6CjiVe3ANV68zu', 'ROLE_VETERINARIO', '678119021', 'ignaciolore90', NULL);
